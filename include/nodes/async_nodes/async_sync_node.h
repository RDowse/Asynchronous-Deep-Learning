...
#ifndef ASYNC_SYNC_NODE_H
#define ASYNC_SYNC_NODE_H
...
class AsyncNeuralNode::SyncNode: public AsyncNeuralNode{
    DataWrapper* dataset;
...
public:
    ...
    SyncNode(shared_ptr<GraphSettings> context): AsyncNeuralNode(context){}
