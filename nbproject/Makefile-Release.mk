...
${TESTDIR}/include/tests/dropoutbitset_test.o: include/tests/dropoutbitset_test.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/include/tests/dropoutbitset_test.o include/tests/dropoutbitset_test.cpp


${TESTDIR}/tests/dropout_tests.o: tests/dropout_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -I. -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/dropout_tests.o tests/dropout_tests.cpp
