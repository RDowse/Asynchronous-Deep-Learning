...
${OBJECTDIR}/src/messages/backward_propagation_message.o: src/messages/backward_propagation_message.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/messages/backward_propagation_message.o src/messages/backward_propagation_message.cpp

${OBJECTDIR}/src/messages/forward_propagation_message.o: src/messages/forward_propagation_message.cpp
	${MKDIR} -p ${OBJECTDIR}/src/messages
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/messages/forward_propagation_message.o src/messages/forward_propagation_message.cpp
...
${OBJECTDIR}/src/nodes/block_nodes/block_hidden_node.o: src/nodes/block_nodes/block_hidden_node.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/block_nodes/block_hidden_node.o src/nodes/block_nodes/block_hidden_node.cpp

${OBJECTDIR}/src/nodes/block_nodes/block_input_node.o: src/nodes/block_nodes/block_input_node.cpp
	${MKDIR} -p ${OBJECTDIR}/src/nodes/block_nodes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/block_nodes/block_input_node.o src/nodes/block_nodes/block_input_node.cpp
...
${OBJECTDIR}/src/nodes/input_node.o: src/nodes/input_node.cpp
	${MKDIR} -p ${OBJECTDIR}/src/nodes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/input_node.o src/nodes/input_node.cpp
...
${OBJECTDIR}/src/nodes/output_node.o: src/nodes/output_node.cpp
	${MKDIR} -p ${OBJECTDIR}/src/nodes
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/output_node.o src/nodes/output_node.cpp
...
${OBJECTDIR}/src/training/stochastic_momentum_training.o: src/training/stochastic_momentum_training.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/training/stochastic_momentum_training.o src/training/stochastic_momentum_training.cpp

${OBJECTDIR}/src/training/stochastic_training.o: src/training/stochastic_training.cpp
	${MKDIR} -p ${OBJECTDIR}/src/training
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/training/stochastic_training.o src/training/stochastic_training.cpp
...
${TESTDIR}/tests/input_node_tests.o: tests/input_node_tests.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/input_node_tests.o tests/input_node_tests.cpp


${TESTDIR}/tests/sync_node_tests.o: tests/sync_node_tests.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/sync_node_tests.o tests/sync_node_tests.cpp
...
${OBJECTDIR}/src/messages/backward_propagation_message_nomain.o: ${OBJECTDIR}/src/messages/backward_propagation_message.o src/messages/backward_propagation_message.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/messages/backward_propagation_message_nomain.o src/messages/backward_propagation_message.cpp;\
	else  \
...
${OBJECTDIR}/src/messages/forward_propagation_message_nomain.o: ${OBJECTDIR}/src/messages/forward_propagation_message.o src/messages/forward_propagation_message.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/messages/forward_propagation_message_nomain.o src/messages/forward_propagation_message.cpp;\
	else  \
...
${OBJECTDIR}/src/misc/node_factory_nomain.o: ${OBJECTDIR}/src/misc/node_factory.o src/misc/node_factory.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/misc/node_factory_nomain.o src/misc/node_factory.cpp;\
	else  \
...
${OBJECTDIR}/src/nodes/bias_node_nomain.o: ${OBJECTDIR}/src/nodes/bias_node.o src/nodes/bias_node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/bias_node_nomain.o src/nodes/bias_node.cpp;\
	else  \
...
${OBJECTDIR}/src/nodes/block_nodes/block_hidden_node_nomain.o: ${OBJECTDIR}/src/nodes/block_nodes/block_hidden_node.o src/nodes/block_nodes/block_hidden_node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/block_nodes/block_hidden_node_nomain.o src/nodes/block_nodes/block_hidden_node.cpp;\
	else  \
...
${OBJECTDIR}/src/nodes/block_nodes/block_input_node_nomain.o: ${OBJECTDIR}/src/nodes/block_nodes/block_input_node.o src/nodes/block_nodes/block_input_node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/block_nodes/block_input_node_nomain.o src/nodes/block_nodes/block_input_node.cpp;\
	else  \
...
${OBJECTDIR}/src/nodes/hidden_node_nomain.o: ${OBJECTDIR}/src/nodes/hidden_node.o src/nodes/hidden_node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/hidden_node_nomain.o src/nodes/hidden_node.cpp;\
	else  \
...
${OBJECTDIR}/src/nodes/input_node_nomain.o: ${OBJECTDIR}/src/nodes/input_node.o src/nodes/input_node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/input_node_nomain.o src/nodes/input_node.cpp;\
	else  \
...
${OBJECTDIR}/src/nodes/node_nomain.o: ${OBJECTDIR}/src/nodes/node.o src/nodes/node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/node_nomain.o src/nodes/node.cpp;\
	else  \
...
${OBJECTDIR}/src/nodes/output_node_nomain.o: ${OBJECTDIR}/src/nodes/output_node.o src/nodes/output_node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/output_node_nomain.o src/nodes/output_node.cpp;\
	else  \
...
${OBJECTDIR}/src/nodes/sync_node_nomain.o: ${OBJECTDIR}/src/nodes/sync_node.o src/nodes/sync_node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/sync_node_nomain.o src/nodes/sync_node.cpp;\
	else  \
...
${OBJECTDIR}/src/states/backward_train_state_nomain.o: ${OBJECTDIR}/src/states/backward_train_state.o src/states/backward_train_state.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/states/backward_train_state_nomain.o src/states/backward_train_state.cpp;\
	else  \
...
${OBJECTDIR}/src/states/forward_train_state_nomain.o: ${OBJECTDIR}/src/states/forward_train_state.o src/states/forward_train_state.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/states/forward_train_state_nomain.o src/states/forward_train_state.cpp;\
	else  \
...
${OBJECTDIR}/src/states/predict_state_nomain.o: ${OBJECTDIR}/src/states/predict_state.o src/states/predict_state.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/states/predict_state_nomain.o src/states/predict_state.cpp;\
	else  \
...
${OBJECTDIR}/src/tools/dnn_graph_nomain.o: ${OBJECTDIR}/src/tools/dnn_graph.o src/tools/dnn_graph.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools/dnn_graph_nomain.o src/tools/dnn_graph.cpp;\
	else  \
...
${OBJECTDIR}/src/tools/logging_nomain.o: ${OBJECTDIR}/src/tools/logging.o src/tools/logging.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/tools/logging_nomain.o src/tools/logging.cpp;\
	else  \
...
${OBJECTDIR}/src/training/stochastic_momentum_training_nomain.o: ${OBJECTDIR}/src/training/stochastic_momentum_training.o src/training/stochastic_momentum_training.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/training/stochastic_momentum_training_nomain.o src/training/stochastic_momentum_training.cpp;\
	else  \
...
${OBJECTDIR}/src/training/stochastic_training_nomain.o: ${OBJECTDIR}/src/training/stochastic_training.o src/training/stochastic_training.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/training/stochastic_training_nomain.o src/training/stochastic_training.cpp;\
	else  \
