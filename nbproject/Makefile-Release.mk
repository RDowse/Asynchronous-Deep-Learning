...
${OBJECTDIR}/src/misc/backward_propagation_edge.o: src/misc/backward_propagation_edge.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/misc/backward_propagation_edge.o src/misc/backward_propagation_edge.cpp

${OBJECTDIR}/src/misc/edge_factory.o: src/misc/edge_factory.cpp
	${MKDIR} -p ${OBJECTDIR}/src/misc
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/misc/edge_factory.o src/misc/edge_factory.cpp

${OBJECTDIR}/src/misc/forward_propagation_edge.o: src/misc/forward_propagation_edge.cpp
	${MKDIR} -p ${OBJECTDIR}/src/misc
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/misc/forward_propagation_edge.o src/misc/forward_propagation_edge.cpp
