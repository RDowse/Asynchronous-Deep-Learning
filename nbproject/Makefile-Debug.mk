...
${OBJECTDIR}/src/nodes/block_nodes/block_sync_node.o: src/nodes/block_nodes/block_sync_node.cpp
	${MKDIR} -p ${OBJECTDIR}/src/nodes/block_nodes
	${RM} "$@.d"
	$(COMPILE.cc) -g -Iinclude -Imnist/include -I/usr/include/eigen3 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/block_nodes/block_sync_node.o src/nodes/block_nodes/block_sync_node.cpp
...
${OBJECTDIR}/src/nodes/block_nodes/block_sync_node_nomain.o: ${OBJECTDIR}/src/nodes/block_nodes/block_sync_node.o src/nodes/block_nodes/block_sync_node.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -Iinclude -Imnist/include -I/usr/include/eigen3 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/nodes/block_nodes/block_sync_node_nomain.o src/nodes/block_nodes/block_sync_node.cpp;\
	else  \
